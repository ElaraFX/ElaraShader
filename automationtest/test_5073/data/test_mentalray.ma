...
//Last modified: Fri, Sep 19, 2014 04:27:18 PM
//Codeset: 936
...
createNode reference -n "testRN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		""
		"test:compositingFlags:objectsRN" 144
		2 "|test:compositingFlags:objects:polySurface2" "miDeriveFromMaya" " 1"
		2 "|test:compositingFlags:objects:polySurface2" "miHide" " 0"
		2 "|test:compositingFlags:objects:polySurface2" "miVisible" " 2"
		2 "|test:compositingFlags:objects:polySurface2" "miTrace" " 2"
		2 "|test:compositingFlags:objects:polySurface2" "miShadow" " 2"
		2 "|test:compositingFlags:objects:polySurface2" "miCaustic" " 5"
		2 "|test:compositingFlags:objects:polySurface2" "miGlobillum" " 5"
		2 "|test:compositingFlags:objects:polySurface2" "miExportGeoShader" " 0"
		2 "|test:compositingFlags:objects:polySurface2" "miProxyRenderable" " 1"
		2 "|test:compositingFlags:objects:polySurface2|test:compositingFlags:objects:polySurfaceShape2" 
		...
		2 "|test:compositingFlags:objects:polySurface2|test:compositingFlags:objects:polySurfaceShape2" 
		"miMaxDisplace" " 0"
		2 "|test:compositingFlags:objects:directionalLight1" "miDeriveFromMaya" " 1"
		
		2 "|test:compositingFlags:objects:directionalLight1" "miHide" " 0"
		2 "|test:compositingFlags:objects:directionalLight1" "miVisible" " 2"
		2 "|test:compositingFlags:objects:directionalLight1" "miTrace" " 2"
		2 "|test:compositingFlags:objects:directionalLight1" "miShadow" " 2"
		2 "|test:compositingFlags:objects:directionalLight1" "miCaustic" " 5"
		2 "|test:compositingFlags:objects:directionalLight1" "miGlobillum" " 5"
		2 "|test:compositingFlags:objects:directionalLight1" "miExportGeoShader" 
		" 0"
		2 "|test:compositingFlags:objects:directionalLight1" "miProxyRenderable" 
		" 1"
		2 "|test:compositingFlags:objects:directionalLight1|test:compositingFlags:objects:directionalLightShape1" 
		"miExportMrLight" " 0"
		2 "|test:compositingFlags:objects:directionalLight1|test:compositingFlags:objects:directionalLightShape1" 
		"emitPhotons" " 0"
		2 "|test:compositingFlags:objects:directionalLight1|test:compositingFlags:objects:directionalLightShape1" 
		...
		2 "test:compositingFlags:objects:LayeredShaderTestNode" "miDeriveFromMaya" 
		" 1"
		2 "test:compositingFlags:objects:LayeredShaderTestNode" "miShinyness" " 10"
		
		2 "test:compositingFlags:objects:LayeredShaderTestNode" "miAngle" " 0"
		2 "test:compositingFlags:objects:LayeredShaderTestNode" "miSpreadX" " 10"
		
		2 "test:compositingFlags:objects:LayeredShaderTestNode" "miSpreadY" " 5"
		2 "test:compositingFlags:objects:LayeredShaderTestNode" "miWhiteness" " -type \"float3\" 0.5 0.5 0.5"
		
		2 "test:compositingFlags:objects:LayeredShaderTestNode" "miSpecularColor" 
		" -type \"float3\" 0.5 0.5 0.5"
		2 "test:compositingFlags:objects:LayeredShaderTestNode" "miReflectivity" 
		" 0.5"
		2 "test:compositingFlags:objects:LayeredShaderTestNode" "miRefractiveIndex" 
		" 1"
		2 "test:compositingFlags:objects:LayeredShaderTestNode" "miRefractions" " 1"
		
		2 "test:compositingFlags:objects:LayeredShaderTestNode" "miAbsorbs" " 1"
		2 "test:compositingFlags:objects:LayeredShaderTestNode" "miDiffuse" " 0.8"
		
		2 "test:compositingFlags:objects:LayeredShaderTestNode" "miColor" " -type \"float3\" 0.5 0.5 0.5"
		
		2 "test:compositingFlags:objects:LayeredShaderTestNode" "miTransparency" 
		" -type \"float3\" 0 0 0"
		2 "test:compositingFlags:objects:LayeredShaderTestNode" "miTranslucence" 
		" 0"
		2 "test:compositingFlags:objects:LayeredShaderTestNode" "miTranslucenceFocus" 
		" 0.5"
		2 "test:compositingFlags:objects:LayeredShaderTestNode" "miNormalCamera" 
		" -type \"float3\" 0 0 0"
		2 "test:compositingFlags:objects:LayeredShaderTestNode" "miFrameBufferWriteOperation" 
		" 1"
		2 "test:compositingFlags:objects:LayeredShaderTestNode" "miFrameBufferWriteFlags" 
		" 0"
		2 "test:compositingFlags:objects:LayeredShaderTestNode" "miFrameBufferWriteFactor" 
		" 1"
		2 "test:compositingFlags:objects:lambert3" "miRefractionBlur" " 0"
		2 "test:compositingFlags:objects:lambert3" "miRefractionRays" " 1"
		2 "test:compositingFlags:objects:lambert3" "miIrradiance" " -type \"float3\" 0 0 0"
		
		2 "test:compositingFlags:objects:lambert3" "miIrradianceColor" " -type \"float3\" 1 1 1"
		
		2 "test:compositingFlags:objects:lambert3" "miDeriveFromMaya" " 1"
		2 "test:compositingFlags:objects:lambert3" "miRefractiveIndex" " 1"
		2 "test:compositingFlags:objects:lambert3" "miRefractions" " 1"
		2 "test:compositingFlags:objects:lambert3" "miAbsorbs" " 1"
		2 "test:compositingFlags:objects:lambert3" "miDiffuse" " 0.8"
		2 "test:compositingFlags:objects:lambert3" "miColor" " -type \"float3\" 0.5 0.5 0.5"
		
		2 "test:compositingFlags:objects:lambert3" "miTransparency" " -type \"float3\" 0 0 0"
		
		2 "test:compositingFlags:objects:lambert3" "miTranslucence" " 0"
		2 "test:compositingFlags:objects:lambert3" "miTranslucenceFocus" " 0.5"
		2 "test:compositingFlags:objects:lambert3" "miNormalCamera" " -type \"float3\" 0 0 0"
		
		2 "test:compositingFlags:objects:lambert3" "miFrameBufferWriteOperation" 
		" 1"
		2 "test:compositingFlags:objects:lambert3" "miFrameBufferWriteFlags" " 0"
		
		2 "test:compositingFlags:objects:lambert3" "miFrameBufferWriteFactor" " 1"
		
		2 "test:compositingFlags:objects:lambert3" "miRefractionBlurLimit" " 1"
		2 "test:compositingFlags:objects:lambert3" "miScatterRadius" " 0"
		2 "test:compositingFlags:objects:lambert3" "miScatterColor" " -type \"float3\" 0.5 0.5 0.5"
		
		2 "test:compositingFlags:objects:lambert3" "miScatterAccuracy" " 97"
		2 "test:compositingFlags:objects:lambert3" "miScatterFalloff" " 0"
		2 "test:compositingFlags:objects:lambert3" "miScatterLimit" " 1"
		2 "test:compositingFlags:objects:lambert3" "miScatterCache" " 0"
		2 "test:compositingFlags:objects:lambert3SG" "miExportMrMaterial" " 0"
		2 "test:compositingFlags:objects:lambert3SG" "miOpaque" " 0"
		2 "test:compositingFlags:objects:lambert3SG" "miCutAwayOpacity" " 0"
		2 "test:compositingFlags:objects:lambert3SG" "miExportShadingEngine" " 1"
		
		2 "test:compositingFlags:objects:lambert3SG" "miExportVolumeSampler" " 0"
		
		2 "test:compositingFlags:objects:lambert3SG" "miContourEnable" " 0"
		2 "test:compositingFlags:objects:lambert3SG" "miContourColor" " -type \"float3\" 1 1 1"
		
		2 "test:compositingFlags:objects:lambert3SG" "miContourAlpha" " 1"
		2 "test:compositingFlags:objects:lambert3SG" "miContourWidth" " 1.25"
		2 "test:compositingFlags:objects:lambert3SG" "miContourRelativeWidth" " 0"
		
		2 "test:compositingFlags:objects:eiStandard1SG" "miExportMrMaterial" " 0"
		
		2 "test:compositingFlags:objects:eiStandard1SG" "miOpaque" " 0"
		2 "test:compositingFlags:objects:eiStandard1SG" "miCutAwayOpacity" " 0"
		2 "test:compositingFlags:objects:eiStandard1SG" "miExportShadingEngine" " 1"
		
		2 "test:compositingFlags:objects:eiStandard1SG" "miExportVolumeSampler" " 0"
		
		2 "test:compositingFlags:objects:eiStandard1SG" "miContourEnable" " 0"
		2 "test:compositingFlags:objects:eiStandard1SG" "miContourColor" " -type \"float3\" 1 1 1"
		
		2 "test:compositingFlags:objects:eiStandard1SG" "miContourAlpha" " 1"
		2 "test:compositingFlags:objects:eiStandard1SG" "miContourWidth" " 1.25"
		2 "test:compositingFlags:objects:eiStandard1SG" "miContourRelativeWidth" 
		" 0"
		"test:compositingFlagsRN" 1
		2 "test:compositingFlags:defaultRenderLayer" "globalIllum" " 0"
		"test:objectsRN" 144
		2 "|test:objects:polySurface2" "miDeriveFromMaya" " 1"
		2 "|test:objects:polySurface2" "miHide" " 0"
		2 "|test:objects:polySurface2" "miVisible" " 2"
		2 "|test:objects:polySurface2" "miTrace" " 2"
		2 "|test:objects:polySurface2" "miShadow" " 2"
		2 "|test:objects:polySurface2" "miCaustic" " 5"
		2 "|test:objects:polySurface2" "miGlobillum" " 5"
		2 "|test:objects:polySurface2" "miExportGeoShader" " 0"
		2 "|test:objects:polySurface2" "miProxyRenderable" " 1"
		2 "|test:objects:polySurface2|test:objects:polySurfaceShape2" "miOverrideCaustics" 
		" 0"
		2 "|test:objects:polySurface2|test:objects:polySurfaceShape2" "miCausticAccuracy" 
		" 64"
		2 "|test:objects:polySurface2|test:objects:polySurfaceShape2" "miCausticRadius" 
		" 0"
		2 "|test:objects:polySurface2|test:objects:polySurfaceShape2" "miOverrideGlobalIllumination" 
		" 0"
		2 "|test:objects:polySurface2|test:objects:polySurfaceShape2" "miGlobillumAccuracy" 
		" 64"
		2 "|test:objects:polySurface2|test:objects:polySurfaceShape2" "miGlobillumRadius" 
		" 0"
		2 "|test:objects:polySurface2|test:objects:polySurfaceShape2" "miOverrideFinalGather" 
		" 0"
		2 "|test:objects:polySurface2|test:objects:polySurfaceShape2" "miFinalGatherRays" 
		" 1000"
		2 "|test:objects:polySurface2|test:objects:polySurfaceShape2" "miFinalGatherMinRadius" 
		" 0"
		2 "|test:objects:polySurface2|test:objects:polySurfaceShape2" "miFinalGatherMaxRadius" 
		" 0"
		2 "|test:objects:polySurface2|test:objects:polySurfaceShape2" "miFinalGatherFilter" 
		" 1"
		2 "|test:objects:polySurface2|test:objects:polySurfaceShape2" "miFinalGatherView" 
		" 0"
		2 "|test:objects:polySurface2|test:objects:polySurfaceShape2" "miOverrideSamples" 
		" 0"
		2 "|test:objects:polySurface2|test:objects:polySurfaceShape2" "miMinSamples" 
		" 0"
		2 "|test:objects:polySurface2|test:objects:polySurfaceShape2" "miMaxSamples" 
		" 2"
		2 "|test:objects:polySurface2|test:objects:polySurfaceShape2" "miFinalGatherCast" 
		" 1"
		2 "|test:objects:polySurface2|test:objects:polySurfaceShape2" "miFinalGatherReceive" 
		" 1"
		2 "|test:objects:polySurface2|test:objects:polySurfaceShape2" "miTransparencyCast" 
		" 1"
		2 "|test:objects:polySurface2|test:objects:polySurfaceShape2" "miTransparencyReceive" 
		" 1"
		2 "|test:objects:polySurface2|test:objects:polySurfaceShape2" "miReflectionReceive" 
		" 1"
		2 "|test:objects:polySurface2|test:objects:polySurfaceShape2" "miRefractionReceive" 
		" 1"
		2 "|test:objects:polySurface2|test:objects:polySurfaceShape2" "miUpdateProxyBoundingBoxMode" 
		" 0"
		2 "|test:objects:polySurface2|test:objects:polySurfaceShape2" "miProxyBoundingBoxMin" 
		" -type \"double3\" 0 0 0"
		2 "|test:objects:polySurface2|test:objects:polySurfaceShape2" "miProxyBoundingBoxMax" 
		" -type \"double3\" 0 0 0"
		2 "|test:objects:polySurface2|test:objects:polySurfaceShape2" "miShadingSamplesOverride" 
		" 0"
		2 "|test:objects:polySurface2|test:objects:polySurfaceShape2" "miShadingSamples" 
		" 0"
		2 "|test:objects:polySurface2|test:objects:polySurfaceShape2" "miMaxDisplaceOverride" 
		" 0"
		2 "|test:objects:polySurface2|test:objects:polySurfaceShape2" "miMaxDisplace" 
		" 0"
		2 "|test:objects:directionalLight1" "miDeriveFromMaya" " 1"
		2 "|test:objects:directionalLight1" "miHide" " 0"
		2 "|test:objects:directionalLight1" "miVisible" " 2"
		2 "|test:objects:directionalLight1" "miTrace" " 2"
		2 "|test:objects:directionalLight1" "miShadow" " 2"
		2 "|test:objects:directionalLight1" "miCaustic" " 5"
		2 "|test:objects:directionalLight1" "miGlobillum" " 5"
		2 "|test:objects:directionalLight1" "miExportGeoShader" " 0"
		2 "|test:objects:directionalLight1" "miProxyRenderable" " 1"
		2 "|test:objects:directionalLight1|test:objects:directionalLightShape1" "miExportMrLight" 
		" 0"
		2 "|test:objects:directionalLight1|test:objects:directionalLightShape1" "emitPhotons" 
		" 0"
		2 "|test:objects:directionalLight1|test:objects:directionalLightShape1" "energy" 
		" -type \"float3\" 8000 8000 8000"
		2 "|test:objects:directionalLight1|test:objects:directionalLightShape1" "photonIntensity" 
		" 1"
		2 "|test:objects:directionalLight1|test:objects:directionalLightShape1" "exponent" 
		" 2"
		2 "|test:objects:directionalLight1|test:objects:directionalLightShape1" "causticPhotons" 
		" 10000"
		2 "|test:objects:directionalLight1|test:objects:directionalLightShape1" "globIllPhotons" 
		" 10000"
		2 "|test:objects:directionalLight1|test:objects:directionalLightShape1" "shadowMap" 
		" 0"
		2 "|test:objects:directionalLight1|test:objects:directionalLightShape1" "smapResolution" 
		" 256"
		2 "|test:objects:directionalLight1|test:objects:directionalLightShape1" "smapSamples" 
		" 1"
		2 "|test:objects:directionalLight1|test:objects:directionalLightShape1" "smapSoftness" 
		" 0"
		2 "|test:objects:directionalLight1|test:objects:directionalLightShape1" "smapBias" 
		" 0"
		2 "|test:objects:directionalLight1|test:objects:directionalLightShape1" "smapLightName" 
		" 0"
		2 "|test:objects:directionalLight1|test:objects:directionalLightShape1" "smapSceneName" 
		" 0"
		2 "|test:objects:directionalLight1|test:objects:directionalLightShape1" "smapFrameExt" 
		" 0"
		2 "|test:objects:directionalLight1|test:objects:directionalLightShape1" "smapDetail" 
		" 0"
		2 "|test:objects:directionalLight1|test:objects:directionalLightShape1" "smapDetailSamples" 
		" 0"
		2 "|test:objects:directionalLight1|test:objects:directionalLightShape1" "smapDetailAccuracy" 
		" 0"
		2 "|test:objects:directionalLight1|test:objects:directionalLightShape1" "smapDetailAlpha" 
		" 0"
		2 "|test:objects:directionalLight1|test:objects:directionalLightShape1" "useShadowMapCamera" 
		" 0"
		2 "|test:objects:directionalLight1|test:objects:directionalLightShape1" "smapCameraAperture" 
		" 1"
		2 "|test:objects:directionalLight1|test:objects:directionalLightShape1" "smapCameraResolution" 
		" 1"
		2 "|test:objects:directionalLight1|test:objects:directionalLightShape1" "smapCameraAspect" 
		" 1"
		...
		2 "test:objects:LayeredShaderTestNode" "miDeriveFromMaya" " 1"
		2 "test:objects:LayeredShaderTestNode" "miShinyness" " 10"
		2 "test:objects:LayeredShaderTestNode" "miAngle" " 0"
		2 "test:objects:LayeredShaderTestNode" "miSpreadX" " 10"
		2 "test:objects:LayeredShaderTestNode" "miSpreadY" " 5"
		2 "test:objects:LayeredShaderTestNode" "miWhiteness" " -type \"float3\" 0.5 0.5 0.5"
		
		2 "test:objects:LayeredShaderTestNode" "miSpecularColor" " -type \"float3\" 0.5 0.5 0.5"
		
		2 "test:objects:LayeredShaderTestNode" "miReflectivity" " 0.5"
		2 "test:objects:LayeredShaderTestNode" "miRefractiveIndex" " 1"
		2 "test:objects:LayeredShaderTestNode" "miRefractions" " 1"
		2 "test:objects:LayeredShaderTestNode" "miAbsorbs" " 1"
		2 "test:objects:LayeredShaderTestNode" "miDiffuse" " 0.8"
		2 "test:objects:LayeredShaderTestNode" "miColor" " -type \"float3\" 0.5 0.5 0.5"
		
		2 "test:objects:LayeredShaderTestNode" "miTransparency" " -type \"float3\" 0 0 0"
		
		2 "test:objects:LayeredShaderTestNode" "miTranslucence" " 0"
		2 "test:objects:LayeredShaderTestNode" "miTranslucenceFocus" " 0.5"
		2 "test:objects:LayeredShaderTestNode" "miNormalCamera" " -type \"float3\" 0 0 0"
		
		2 "test:objects:LayeredShaderTestNode" "miFrameBufferWriteOperation" " 1"
		
		2 "test:objects:LayeredShaderTestNode" "miFrameBufferWriteFlags" " 0"
		2 "test:objects:LayeredShaderTestNode" "miFrameBufferWriteFactor" " 1"
		2 "test:objects:lambert3" "miRefractionBlur" " 0"
		2 "test:objects:lambert3" "miRefractionRays" " 1"
		2 "test:objects:lambert3" "miIrradiance" " -type \"float3\" 0 0 0"
		2 "test:objects:lambert3" "miIrradianceColor" " -type \"float3\" 1 1 1"
		2 "test:objects:lambert3" "miDeriveFromMaya" " 1"
		2 "test:objects:lambert3" "miRefractiveIndex" " 1"
		2 "test:objects:lambert3" "miRefractions" " 1"
		2 "test:objects:lambert3" "miAbsorbs" " 1"
		2 "test:objects:lambert3" "miDiffuse" " 0.8"
		2 "test:objects:lambert3" "miColor" " -type \"float3\" 0.5 0.5 0.5"
		2 "test:objects:lambert3" "miTransparency" " -type \"float3\" 0 0 0"
		2 "test:objects:lambert3" "miTranslucence" " 0"
		2 "test:objects:lambert3" "miTranslucenceFocus" " 0.5"
		2 "test:objects:lambert3" "miNormalCamera" " -type \"float3\" 0 0 0"
		2 "test:objects:lambert3" "miFrameBufferWriteOperation" " 1"
		2 "test:objects:lambert3" "miFrameBufferWriteFlags" " 0"
		2 "test:objects:lambert3" "miFrameBufferWriteFactor" " 1"
		2 "test:objects:lambert3" "miRefractionBlurLimit" " 1"
		2 "test:objects:lambert3" "miScatterRadius" " 0"
		2 "test:objects:lambert3" "miScatterColor" " -type \"float3\" 0.5 0.5 0.5"
		
		2 "test:objects:lambert3" "miScatterAccuracy" " 97"
		2 "test:objects:lambert3" "miScatterFalloff" " 0"
		2 "test:objects:lambert3" "miScatterLimit" " 1"
		2 "test:objects:lambert3" "miScatterCache" " 0"
		2 "test:objects:lambert3SG" "miExportMrMaterial" " 0"
		2 "test:objects:lambert3SG" "miOpaque" " 0"
		2 "test:objects:lambert3SG" "miCutAwayOpacity" " 0"
		2 "test:objects:lambert3SG" "miExportShadingEngine" " 1"
		2 "test:objects:lambert3SG" "miExportVolumeSampler" " 0"
		2 "test:objects:lambert3SG" "miContourEnable" " 0"
		2 "test:objects:lambert3SG" "miContourColor" " -type \"float3\" 1 1 1"
		2 "test:objects:lambert3SG" "miContourAlpha" " 1"
		2 "test:objects:lambert3SG" "miContourWidth" " 1.25"
		2 "test:objects:lambert3SG" "miContourRelativeWidth" " 0"
		2 "test:objects:eiStandard1SG" "miExportMrMaterial" " 0"
		2 "test:objects:eiStandard1SG" "miOpaque" " 0"
		2 "test:objects:eiStandard1SG" "miCutAwayOpacity" " 0"
		2 "test:objects:eiStandard1SG" "miExportShadingEngine" " 1"
		2 "test:objects:eiStandard1SG" "miExportVolumeSampler" " 0"
		2 "test:objects:eiStandard1SG" "miContourEnable" " 0"
		2 "test:objects:eiStandard1SG" "miContourColor" " -type \"float3\" 1 1 1"
		
		2 "test:objects:eiStandard1SG" "miContourAlpha" " 1"
		2 "test:objects:eiStandard1SG" "miContourWidth" " 1.25"
		2 "test:objects:eiStandard1SG" "miContourRelativeWidth" " 0";
...
createNode delightRenderPass -n "renderPass";
	...
	setAttr ".layerDefaultDisplayDriver" -type "string" "png";
	setAttr ".layerDefaultQuantizeOne" 255;
	setAttr ".layerDefaultQuantizeMax" 255;
	setAttr ".layerDefaultQuantizeDither" 0.5;
	setAttr ".layerDefaultHalfFloat" no;
