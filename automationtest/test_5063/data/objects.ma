...
//Name: objects.ma
//Last modified: Tue, Aug 12, 2014 12:07:00 AM
//Codeset: 936
requires maya "2013";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 11.498475309383101 22.70838523276192 -0.65535007177456261 ;
	setAttr ".r" -type "double3" -63.938352729581524 98.999999999999559 -2.5444437451708134e-014 ;
createNode camera -s -n "perspShape" -p "persp";
	addAttr -ci true -h true -sn "usedBy3dfm" -ln "usedBy3dfm" -at "message";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 25.585945372115681;
...
connectAttr "cloth2.oc" "test_lambert.c";
...
connectAttr "cloth2.msg" "materialInfo2.t" -na;
