...
//Last modified: Tue, Sep 30, 2014 02:58:59 PM
//Codeset: 936
file -rdi 1 -ns "test" -rfn "testRN" "K:/osl/testCase//test_5063/data/test.ma";
file -rdi 2 -ns "alphaGain" -rfn "test:alphaGainRN" "D:/Projects/2014/osl/testCase//test_5059/data/alphaGain.ma";
file -rdi 3 -ns "objects" -rfn "test:alphaGain:objectsRN" "D:/Projects/2014/osl/testCase//test_5059/data/objects.ma";
file -rdi 2 -ns "alphaIsLuminance" -rfn "test:alphaIsLuminanceRN" "D:/Projects/2014/osl/testCase//test_5059/data/alphaIsLuminance.ma";
file -rdi 3 -ns "objects" -rfn "test:alphaIsLuminance:objectsRN" "D:/Projects/2014/osl/testCase//test_5059/data/objects.ma";
file -rdi 2 -ns "alphaOffset" -rfn "test:alphaOffsetRN" "D:/Projects/2014/osl/testCase//test_5059/data/alphaOffset.ma";
file -rdi 3 -ns "objects" -rfn "test:alphaOffset:objectsRN" "D:/Projects/2014/osl/testCase//test_5059/data/objects.ma";
file -rdi 2 -ns "brightSpread" -rfn "test:brightSpreadRN" "D:/Projects/2014/osl/testCase//test_5059/data/brightSpread.ma";
file -rdi 3 -ns "objects" -rfn "test:brightSpread:objectsRN" "D:/Projects/2014/osl/testCase//test_5059/data/objects.ma";
file -rdi 2 -ns "colorGain" -rfn "test:colorGainRN" "D:/Projects/2014/osl/testCase//test_5059/data/colorGain.ma";
file -rdi 3 -ns "objects" -rfn "test:colorGain:objectsRN" "D:/Projects/2014/osl/testCase//test_5059/data/objects.ma";
file -rdi 2 -ns "colorOffset" -rfn "test:colorOffsetRN" "D:/Projects/2014/osl/testCase//test_5059/data/colorOffset.ma";
file -rdi 3 -ns "objects" -rfn "test:colorOffset:objectsRN" "D:/Projects/2014/osl/testCase//test_5059/data/objects.ma";
file -rdi 2 -ns "defaultColor" -rfn "test:defaultColorRN" "D:/Projects/2014/osl/testCase//test_5059/data/defaultColor.ma";
file -rdi 3 -ns "objects" -rfn "test:defaultColor:objectsRN" "D:/Projects/2014/osl/testCase//test_5059/data/objects.ma";
file -rdi 2 -ns "gapColor" -rfn "test:gapColorRN" "D:/Projects/2014/osl/testCase//test_5059/data/gapColor.ma";
file -rdi 3 -ns "objects" -rfn "test:gapColor:objectsRN" "D:/Projects/2014/osl/testCase//test_5059/data/objects.ma";
file -rdi 2 -ns "invert" -rfn "test:invertRN" "D:/Projects/2014/osl/testCase//test_5059/data/invert.ma";
file -rdi 3 -ns "objects" -rfn "test:invert:objectsRN" "D:/Projects/2014/osl/testCase//test_5059/data/objects.ma";
file -rdi 2 -ns "randomness" -rfn "test:randomnessRN" "D:/Projects/2014/osl/testCase//test_5059/data/randomness.ma";
file -rdi 3 -ns "objects" -rfn "test:randomness:objectsRN" "D:/Projects/2014/osl/testCase//test_5059/data/objects.ma";
file -rdi 2 -ns "uColor" -rfn "test:uColorRN" "D:/Projects/2014/osl/testCase//test_5059/data/uColor.ma";
file -rdi 3 -ns "objects" -rfn "test:uColor:objectsRN" "D:/Projects/2014/osl/testCase//test_5059/data/objects.ma";
file -rdi 2 -ns "uWave" -rfn "test:uWaveRN" "D:/Projects/2014/osl/testCase//test_5059/data/uWave.ma";
file -rdi 3 -ns "objects" -rfn "test:uWave:objectsRN" "D:/Projects/2014/osl/testCase//test_5059/data/objects.ma";
file -rdi 2 -ns "uWidth" -rfn "test:uWidthRN" "D:/Projects/2014/osl/testCase//test_5059/data/uWidth.ma";
file -rdi 3 -ns "objects" -rfn "test:uWidth:objectsRN" "D:/Projects/2014/osl/testCase//test_5059/data/objects.ma";
file -rdi 2 -ns "vColor" -rfn "test:vColorRN" "D:/Projects/2014/osl/testCase//test_5059/data/vColor.ma";
file -rdi 3 -ns "objects" -rfn "test:vColor:objectsRN" "D:/Projects/2014/osl/testCase//test_5059/data/objects.ma";
file -rdi 2 -ns "vWave" -rfn "test:vWaveRN" "D:/Projects/2014/osl/testCase//test_5059/data/vWave.ma";
file -rdi 3 -ns "objects" -rfn "test:vWave:objectsRN" "D:/Projects/2014/osl/testCase//test_5059/data/objects.ma";
file -rdi 2 -ns "vWidth" -rfn "test:vWidthRN" "D:/Projects/2014/osl/testCase//test_5059/data/vWidth.ma";
file -rdi 3 -ns "objects" -rfn "test:vWidth:objectsRN" "D:/Projects/2014/osl/testCase//test_5059/data/objects.ma";
file -rdi 2 -ns "widthSpread" -rfn "test:widthSpreadRN" "D:/Projects/2014/osl/testCase//test_5059/data/widthSpread.ma";
file -rdi 3 -ns "objects" -rfn "test:widthSpread:objectsRN" "D:/Projects/2014/osl/testCase//test_5059/data/objects.ma";
file -r -ns "test" -dr 1 -rfn "testRN" "K:/osl/testCase//test_5063/data/test.ma";
requires maya "2013";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -21.308253383320071 64.509590264615838 56.624714772585811 ;
	setAttr ".r" -type "double3" -42.938352729602478 22.200000000000092 3.4352043726675094e-015 ;
createNode camera -s -n "perspShape" -p "persp";
	addAttr -ci true -h true -sn "usedBy3dfm" -ln "usedBy3dfm" -at "message";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 71.97455516173973;
...
createNode reference -n "testRN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		"testRN"
		"test:alphaGainRN" 0
		"test:randomness:objectsRN" 0
		"test:brightSpread:objectsRN" 0
		"test:randomnessRN" 0
		"test:vWaveRN" 0
		"test:uWave:objectsRN" 0
		"test:defaultColor:objectsRN" 0
		"test:widthSpreadRN" 0
		"test:vWidthRN" 0
		"test:uWidthRN" 0
		"test:alphaGain:objectsRN" 0
		"test:vWidth:objectsRN" 0
		"test:vWave:objectsRN" 0
		"test:alphaOffset:objectsRN" 0
		"test:invert:objectsRN" 0
		"test:uColor:objectsRN" 0
		"test:colorOffsetRN" 0
		"test:colorGainRN" 0
		"test:uWidth:objectsRN" 0
		"test:uWaveRN" 0
		"test:alphaOffsetRN" 0
		"test:vColor:objectsRN" 0
		"test:gapColor:objectsRN" 0
		"test:brightSpreadRN" 0
		"test:alphaIsLuminanceRN" 0
		"test:alphaIsLuminance:objectsRN" 0
		"test:widthSpread:objectsRN" 0
		"test:gapColorRN" 0
		"test:invertRN" 0
		"test:vColorRN" 0
		"test:uColorRN" 0
		"test:colorOffset:objectsRN" 0
		"testRN" 0
		"test:colorGain:objectsRN" 0
		...
		5 3 "testRN" "|test:persp1|test:perspShape2.usedBy3dfm" "testRN.placeHolderList[2]" 
		""
		"test:alphaGain:objectsRN" 2
		2 "test:alphaGain:objects:renderPass" "numberOfCPUs" " 0"
		5 4 "testRN" "test:alphaGain:objects:renderPass.layerToRender" "testRN.placeHolderList[1]" 
		"";
...
connectAttr "testRN.phl[2]" "renderPass.camera";
connectAttr "defaultRenderLayer.usedBy3dfm" "testRN.phl[1]";
