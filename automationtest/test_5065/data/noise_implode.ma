...
//Name: noise_implode.ma
//Last modified: Thu, Sep 04, 2014 09:29:45 AM
//Codeset: 936
requires maya "2013";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 10.512755798872607 7.8845668491544574 10.512755798872618 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 16.828620364493474;
...
createNode transform -n "directionalLight1";
	setAttr ".t" -type "double3" 0 0 1.0526756922042113 ;
	setAttr ".r" -type "double3" -52.576115628979728 0 0 ;
	setAttr ".rpt" -type "double3" 0 8.5297680461779107e-019 -2.2710493017867007e-019 ;
createNode directionalLight -n "directionalLightShape1" -p "directionalLight1";
	setAttr -k off ".v";
	setAttr ".in" 3.8073394298553467;
...
createNode noise -n "noise2";
	setAttr ".ra" 0.64732140302658081;
	setAttr ".dm" 8;
	setAttr ".fq" 1.3392857313156128;
	setAttr ".fr" 2.6473214626312256;
	setAttr ".nty" 0;
	setAttr ".nw" 10;
	setAttr ".imp" 0.96428573131561279;
...
connectAttr "noise2.oc" "lambert2.c";
connectAttr "lambert2.oc" "lambert2SG.ss";
connectAttr "pPlaneShape1.iog" "lambert2SG.dsm" -na;
connectAttr "lambert2SG.msg" "materialInfo1.sg";
connectAttr "lambert2.msg" "materialInfo1.m";
connectAttr "noise2.msg" "materialInfo1.t" -na;
