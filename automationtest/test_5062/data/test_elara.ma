...
//Name: test_elara.ma
//Last modified: Tue, Aug 12, 2014 06:27:43 PM
//Codeset: 936
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -31.518804006345626 194.99130599733388 -29.509081346865102 ;
...
createNode transform -n "persp1";
	setAttr ".t" -type "double3" -9.1818811033825973 20.387855049909682 -6.7874088132409165 ;
	setAttr -l on ".tx";
	setAttr -l on ".ty";
	setAttr -l on ".tz";
...
createNode reference -n "alphaGainRN";
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		2 "|alphaGain:objects:polySurface1" "translate" " -type \"double3\" -1.869323 0 0"
...
createNode reference -n "alphaIsLuminanceRN";
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		2 "|alphaIsLuminance:objects:polySurface1" "translate" " -type \"double3\" -4.876547 0 0"
...
createNode reference -n "alphaOffsetRN";
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		2 "|alphaOffset:objects:polySurface1" "translate" " -type \"double3\" -7.975627 0 0"
...
createNode reference -n "amplitudeRN";
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		2 "|amplitude:objects:polySurface1" "translate" " -type \"double3\" -10.803205 0 0"
...
createNode reference -n "colorGainRN";
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		2 "|colorGain:objects:polySurface1" "translate" " -type \"double3\" -13.722513 0 0"
...
createNode reference -n "colorOffsetRN";
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		2 "|colorOffset:objects:polySurface1" "translate" " -type \"double3\" -16.734055 0 0"
...
createNode reference -n "contrastRN";
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		2 "|contrast:objects:polySurface1" "translate" " -type \"double3\" -1.880599 0 -6.343442"
...
createNode reference -n "defaultColorRN";
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		2 "|defaultColor:objects:polySurface1" "translate" " -type \"double3\" -4.942787 0 -6.343442"
...
createNode reference -n "depthRN";
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		"depthRN" 0
		"depth:objectsRN" 2
		2 "|depth:objects:polySurface1" "translate" " -type \"double3\" -7.962909 0 -6.343442"
...
createNode reference -n "diffusionRN";
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		2 "|diffusion:objects:polySurface1" "translate" " -type \"double3\" -10.846577 0 -6.343442"
...
createNode reference -n "fillerColorRN";
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		2 "|fillerColor:objects:polySurface1" "translate" " -type \"double3\" -13.828609 0 -6.343442"
...
createNode reference -n "invertRN";
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		"invert:objectsRN" 0
		"invert:objectsRN" 2
		2 "|invert:objects:polySurface1" "translate" " -type \"double3\" -16.811941 0 -6.343442"
...
createNode reference -n "ratioRN";
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		"ratio:objectsRN" 0
		"ratio:objectsRN" 2
		2 "|ratio:objects:polySurface1" "translate" " -type \"double3\" -3.531767 0 -13.124957"
...
createNode reference -n "ripplesRN";
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		"ripples:objectsRN" 0
		"ripples:objectsRN" 2
		2 "|ripples:objects:polySurface1" "translate" " -type \"double3\" -6.561381 0 -13.124957"
...
createNode reference -n "veinColorRN";
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		2 "|veinColor:objects:polySurface1" "translate" " -type \"double3\" -9.948376 0 -13.124957"
...
createNode reference -n "veinWidthRN";
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		2 "|veinWidth:objects:polySurface1" "translate" " -type \"double3\" -13.460122 0 -13.124957"
