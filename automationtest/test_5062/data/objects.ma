...
//Name: objects.ma
//Last modified: Tue, Aug 12, 2014 04:23:42 PM
//Codeset: 936
requires maya "2013";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 1.9327131572765466 6.8021615975909633 -0.0087324840756900918 ;
	setAttr ".r" -type "double3" -74.138352729630512 89.799999999999599 9.1116364916471218e-013 ;
createNode camera -s -n "perspShape" -p "persp";
	addAttr -ci true -h true -sn "usedBy3dfm" -ln "usedBy3dfm" -at "message";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999986;
	setAttr ".coi" 7.0714091992258323;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" 0 0 -0.015478953095279913 ;
...
createNode transform -n "polySurface1";
	setAttr ".s" -type "double3" 0.15951195656489228 0.15951195656489228 0.15951195656489228 ;
createNode mesh -n "polySurfaceShape1" -p "polySurface1";
	setAttr -k off ".v";
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".uvst[0].uvsn" -type "string" "map1";
	setAttr -s 8 ".uvst[0].uvsp[0:7]" -type "float2" 0 0 1 0 0 1 1 1 -2.6345284
		 -2.6345284 3.63452816 -2.6345284 3.63452816 3.63452816 -2.6345284 3.63452816;
	setAttr ".cuvs" -type "string" "map1";
	setAttr ".dcc" -type "string" "Ambient+Diffuse";
	setAttr ".covm[0]"  0 1 1;
	setAttr ".cdvm[0]"  0 1 1;
	setAttr -s 4 ".pt[2:5]" -type "float3"  0 0 -0.20575714 0 0 -0.20575714 
		0 0 0.20575714 0 0 0.20575714;
	setAttr -s 8 ".vt[0:7]"  -8.12541771 -1.8042052e-015 16.40370941 8.12541771 -1.8042052e-015 16.40370941
		 -8.12541771 1.8042052e-015 0.15287399 8.12541771 1.8042052e-015 0.15287399 -8.12541771 -1.8042052e-015 -0.25864029
		 8.12541771 -1.8042052e-015 -0.25864029 -8.12541771 1.8042052e-015 -16.50947571 8.12541771 1.8042052e-015 -16.50947571;
...
createNode transform -n "directionalLight1";
	setAttr ".t" -type "double3" -4.6212155294285928 0.96222826591613131 3.9320928162985216 ;
	setAttr ".r" -type "double3" -110.34085864555485 20.878944871495442 -7.5980368830598959 ;
...
createNode lambert -n "test_lambert";
	setAttr ".dc" 1;
...
connectAttr "marble1.oc" "test_lambert.c";
connectAttr "test_lambert.oc" "lambert2SG.ss";
connectAttr "polySurfaceShape1.iog" "lambert2SG.dsm" -na;
connectAttr "lambert2SG.msg" "materialInfo2.sg";
connectAttr "test_lambert.msg" "materialInfo2.m";
connectAttr "marble1.msg" "materialInfo2.t" -na;
connectAttr "place3dTexture1.wim" "marble1.pm";
connectAttr "surfaceShader1SG.pa" ":renderPartition.st" -na;
connectAttr "lambert2SG.pa" ":renderPartition.st" -na;
connectAttr "test_lambert.msg" ":defaultShaderList1.s" -na;
