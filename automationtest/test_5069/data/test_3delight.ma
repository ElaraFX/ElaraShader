...
//Last modified: Mon, Sep 22, 2014 04:54:54 PM
//Codeset: 936
file -rdi 1 -ns "test" -rfn "testRN" "K:/osl/testCase//test_5069/data/test.ma";
file -rdi 2 -ns "bias" -rfn "test:biasRN" "K:/osl/testCase//test_5069/data/bias.ma";
file -rdi 3 -ns "object" -rfn "test:bias:objectRN" "K:/osl/testCase//test_5069/data/object.ma";
file -rdi 2 -ns "bias_2" -rfn "test:bias_2RN" "K:/osl/testCase//test_5069/data/bias_2.ma";
file -rdi 3 -ns "object" -rfn "test:bias_2:objectRN" "K:/osl/testCase//test_5069/data/object.ma";
file -rdi 2 -ns "contrast" -rfn "test:contrastRN" "K:/osl/testCase//test_5069/data/contrast.ma";
file -rdi 3 -ns "object" -rfn "test:contrast:objectRN" "K:/osl/testCase//test_5069/data/object.ma";
file -rdi 2 -ns "contrast_2" -rfn "test:contrast_2RN" "K:/osl/testCase//test_5069/data/contrast_2.ma";
file -rdi 3 -ns "object" -rfn "test:contrast_2:objectRN" "K:/osl/testCase//test_5069/data/object.ma";
file -rdi 2 -ns "object" -rfn "test:objectRN" "K:/osl/testCase//test_5069/data/object.ma";
file -rdi 2 -ns "value" -rfn "test:valueRN" "K:/osl/testCase//test_5069/data/value.ma";
file -rdi 3 -ns "object" -rfn "test:value:objectRN" "K:/osl/testCase//test_5069/data/object.ma";
file -r -ns "test" -dr 1 -rfn "testRN" "K:/osl/testCase//test_5069/data/test.ma";
requires maya "2013";
...
createNode reference -n "testRN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		"test:biasRN" 0
		"test:bias:objectRN" 0
		"test:contrast_2RN" 0
		"testRN" 0
		"test:bias_2:objectRN" 0
		"test:contrast_2:objectRN" 0
		...
		"test:biasRN" 1
		2 "test:bias:defaultRenderLayer" "globalIllum" " 0"
		"test:bias:objectRN" 104
		2 "|test:bias:object:pPlane1" "miDeriveFromMaya" " 1"
		2 "|test:bias:object:pPlane1" "miHide" " 0"
		2 "|test:bias:object:pPlane1" "miVisible" " 2"
		2 "|test:bias:object:pPlane1" "miTrace" " 2"
		2 "|test:bias:object:pPlane1" "miShadow" " 2"
		2 "|test:bias:object:pPlane1" "miCaustic" " 5"
		2 "|test:bias:object:pPlane1" "miGlobillum" " 5"
		2 "|test:bias:object:pPlane1" "miExportGeoShader" " 0"
		2 "|test:bias:object:pPlane1" "miProxyRenderable" " 1"
		2 "|test:bias:object:pPlane1|test:bias:object:pPlaneShape1" "miOverrideCaustics" 
		" 0"
		2 "|test:bias:object:pPlane1|test:bias:object:pPlaneShape1" "miCausticAccuracy" 
		" 64"
		2 "|test:bias:object:pPlane1|test:bias:object:pPlaneShape1" "miCausticRadius" 
		" 0"
		2 "|test:bias:object:pPlane1|test:bias:object:pPlaneShape1" "miOverrideGlobalIllumination" 
		" 0"
		2 "|test:bias:object:pPlane1|test:bias:object:pPlaneShape1" "miGlobillumAccuracy" 
		" 64"
		2 "|test:bias:object:pPlane1|test:bias:object:pPlaneShape1" "miGlobillumRadius" 
		" 0"
		2 "|test:bias:object:pPlane1|test:bias:object:pPlaneShape1" "miOverrideFinalGather" 
		" 0"
		2 "|test:bias:object:pPlane1|test:bias:object:pPlaneShape1" "miFinalGatherRays" 
		" 1000"
		2 "|test:bias:object:pPlane1|test:bias:object:pPlaneShape1" "miFinalGatherMinRadius" 
		" 0"
		2 "|test:bias:object:pPlane1|test:bias:object:pPlaneShape1" "miFinalGatherMaxRadius" 
		" 0"
		2 "|test:bias:object:pPlane1|test:bias:object:pPlaneShape1" "miFinalGatherFilter" 
		" 1"
		2 "|test:bias:object:pPlane1|test:bias:object:pPlaneShape1" "miFinalGatherView" 
		" 0"
		2 "|test:bias:object:pPlane1|test:bias:object:pPlaneShape1" "miOverrideSamples" 
		" 0"
		2 "|test:bias:object:pPlane1|test:bias:object:pPlaneShape1" "miMinSamples" 
		" 0"
		2 "|test:bias:object:pPlane1|test:bias:object:pPlaneShape1" "miMaxSamples" 
		" 2"
		2 "|test:bias:object:pPlane1|test:bias:object:pPlaneShape1" "miFinalGatherCast" 
		" 1"
		2 "|test:bias:object:pPlane1|test:bias:object:pPlaneShape1" "miFinalGatherReceive" 
		" 1"
		2 "|test:bias:object:pPlane1|test:bias:object:pPlaneShape1" "miTransparencyCast" 
		" 1"
		2 "|test:bias:object:pPlane1|test:bias:object:pPlaneShape1" "miTransparencyReceive" 
		" 1"
		2 "|test:bias:object:pPlane1|test:bias:object:pPlaneShape1" "miReflectionReceive" 
		" 1"
		2 "|test:bias:object:pPlane1|test:bias:object:pPlaneShape1" "miRefractionReceive" 
		" 1"
		2 "|test:bias:object:pPlane1|test:bias:object:pPlaneShape1" "miUpdateProxyBoundingBoxMode" 
		" 0"
		2 "|test:bias:object:pPlane1|test:bias:object:pPlaneShape1" "miProxyBoundingBoxMin" 
		" -type \"double3\" 0 0 0"
		2 "|test:bias:object:pPlane1|test:bias:object:pPlaneShape1" "miProxyBoundingBoxMax" 
		" -type \"double3\" 0 0 0"
		2 "|test:bias:object:pPlane1|test:bias:object:pPlaneShape1" "miShadingSamplesOverride" 
		" 0"
		2 "|test:bias:object:pPlane1|test:bias:object:pPlaneShape1" "miShadingSamples" 
		" 0"
		2 "|test:bias:object:pPlane1|test:bias:object:pPlaneShape1" "miMaxDisplaceOverride" 
		" 0"
		2 "|test:bias:object:pPlane1|test:bias:object:pPlaneShape1" "miMaxDisplace" 
		" 0"
		2 "|test:bias:object:directionalLight1" "miDeriveFromMaya" " 1"
		2 "|test:bias:object:directionalLight1" "miHide" " 0"
		2 "|test:bias:object:directionalLight1" "miVisible" " 2"
		2 "|test:bias:object:directionalLight1" "miTrace" " 2"
		2 "|test:bias:object:directionalLight1" "miShadow" " 2"
		2 "|test:bias:object:directionalLight1" "miCaustic" " 5"
		2 "|test:bias:object:directionalLight1" "miGlobillum" " 5"
		2 "|test:bias:object:directionalLight1" "miExportGeoShader" " 0"
		2 "|test:bias:object:directionalLight1" "miProxyRenderable" " 1"
		2 "|test:bias:object:directionalLight1|test:bias:object:directionalLightShape1" 
		"miExportMrLight" " 0"
		2 "|test:bias:object:directionalLight1|test:bias:object:directionalLightShape1" 
		"emitPhotons" " 0"
		2 "|test:bias:object:directionalLight1|test:bias:object:directionalLightShape1" 
		...
		2 "|test:bias:object:directionalLight1|test:bias:object:directionalLightShape1" 
		"smapCameraAspect" " 1"
		2 "test:bias:object:defaultRenderLayer" "globalIllum" " 0"
		2 "test:bias:object:lambert2" "miRefractionBlur" " 0"
		2 "test:bias:object:lambert2" "miRefractionRays" " 1"
		2 "test:bias:object:lambert2" "miIrradiance" " -type \"float3\" 0 0 0"
		2 "test:bias:object:lambert2" "miIrradianceColor" " -type \"float3\" 1 1 1"
		
		2 "test:bias:object:lambert2" "miDeriveFromMaya" " 1"
		2 "test:bias:object:lambert2" "miRefractiveIndex" " 1"
		2 "test:bias:object:lambert2" "miRefractions" " 1"
		2 "test:bias:object:lambert2" "miAbsorbs" " 1"
		2 "test:bias:object:lambert2" "miDiffuse" " 0.8"
		2 "test:bias:object:lambert2" "miColor" " -type \"float3\" 0.5 0.5 0.5"
		2 "test:bias:object:lambert2" "miTransparency" " -type \"float3\" 0 0 0"
		2 "test:bias:object:lambert2" "miTranslucence" " 0"
		2 "test:bias:object:lambert2" "miTranslucenceFocus" " 0.5"
		2 "test:bias:object:lambert2" "miNormalCamera" " -type \"float3\" 0 0 0"
		2 "test:bias:object:lambert2" "miFrameBufferWriteOperation" " 1"
		2 "test:bias:object:lambert2" "miFrameBufferWriteFlags" " 0"
		2 "test:bias:object:lambert2" "miFrameBufferWriteFactor" " 1"
		2 "test:bias:object:lambert2" "miRefractionBlurLimit" " 1"
		2 "test:bias:object:lambert2" "miScatterRadius" " 0"
		2 "test:bias:object:lambert2" "miScatterColor" " -type \"float3\" 0.5 0.5 0.5"
		
		2 "test:bias:object:lambert2" "miScatterAccuracy" " 97"
		2 "test:bias:object:lambert2" "miScatterFalloff" " 0"
		2 "test:bias:object:lambert2" "miScatterLimit" " 1"
		2 "test:bias:object:lambert2" "miScatterCache" " 0"
		2 "test:bias:object:lambert2SG" "miExportMrMaterial" " 0"
		2 "test:bias:object:lambert2SG" "miOpaque" " 0"
		2 "test:bias:object:lambert2SG" "miCutAwayOpacity" " 0"
		2 "test:bias:object:lambert2SG" "miExportShadingEngine" " 1"
		2 "test:bias:object:lambert2SG" "miExportVolumeSampler" " 0"
		2 "test:bias:object:lambert2SG" "miContourEnable" " 0"
		2 "test:bias:object:lambert2SG" "miContourColor" " -type \"float3\" 1 1 1"
		
		2 "test:bias:object:lambert2SG" "miContourAlpha" " 1"
		2 "test:bias:object:lambert2SG" "miContourWidth" " 1.25"
		2 "test:bias:object:lambert2SG" "miContourRelativeWidth" " 0"
		"test:contrast_2RN" 1
		2 "test:contrast_2:defaultRenderLayer" "globalIllum" " 0"
		"testRN" 58
		...
		""
		"test:bias_2:objectRN" 104
		2 "|test:bias_2:object:pPlane1" "miDeriveFromMaya" " 1"
		2 "|test:bias_2:object:pPlane1" "miHide" " 0"
		2 "|test:bias_2:object:pPlane1" "miVisible" " 2"
		2 "|test:bias_2:object:pPlane1" "miTrace" " 2"
		2 "|test:bias_2:object:pPlane1" "miShadow" " 2"
		2 "|test:bias_2:object:pPlane1" "miCaustic" " 5"
		2 "|test:bias_2:object:pPlane1" "miGlobillum" " 5"
		2 "|test:bias_2:object:pPlane1" "miExportGeoShader" " 0"
		2 "|test:bias_2:object:pPlane1" "miProxyRenderable" " 1"
		2 "|test:bias_2:object:pPlane1|test:bias_2:object:pPlaneShape1" "miOverrideCaustics" 
		" 0"
		2 "|test:bias_2:object:pPlane1|test:bias_2:object:pPlaneShape1" "miCausticAccuracy" 
		" 64"
		2 "|test:bias_2:object:pPlane1|test:bias_2:object:pPlaneShape1" "miCausticRadius" 
		" 0"
		2 "|test:bias_2:object:pPlane1|test:bias_2:object:pPlaneShape1" "miOverrideGlobalIllumination" 
		" 0"
		2 "|test:bias_2:object:pPlane1|test:bias_2:object:pPlaneShape1" "miGlobillumAccuracy" 
		" 64"
		2 "|test:bias_2:object:pPlane1|test:bias_2:object:pPlaneShape1" "miGlobillumRadius" 
		" 0"
		2 "|test:bias_2:object:pPlane1|test:bias_2:object:pPlaneShape1" "miOverrideFinalGather" 
		" 0"
		2 "|test:bias_2:object:pPlane1|test:bias_2:object:pPlaneShape1" "miFinalGatherRays" 
		" 1000"
		2 "|test:bias_2:object:pPlane1|test:bias_2:object:pPlaneShape1" "miFinalGatherMinRadius" 
		" 0"
		2 "|test:bias_2:object:pPlane1|test:bias_2:object:pPlaneShape1" "miFinalGatherMaxRadius" 
		" 0"
		2 "|test:bias_2:object:pPlane1|test:bias_2:object:pPlaneShape1" "miFinalGatherFilter" 
		" 1"
		2 "|test:bias_2:object:pPlane1|test:bias_2:object:pPlaneShape1" "miFinalGatherView" 
		" 0"
		2 "|test:bias_2:object:pPlane1|test:bias_2:object:pPlaneShape1" "miOverrideSamples" 
		" 0"
		2 "|test:bias_2:object:pPlane1|test:bias_2:object:pPlaneShape1" "miMinSamples" 
		" 0"
		2 "|test:bias_2:object:pPlane1|test:bias_2:object:pPlaneShape1" "miMaxSamples" 
		" 2"
		2 "|test:bias_2:object:pPlane1|test:bias_2:object:pPlaneShape1" "miFinalGatherCast" 
		" 1"
		2 "|test:bias_2:object:pPlane1|test:bias_2:object:pPlaneShape1" "miFinalGatherReceive" 
		" 1"
		2 "|test:bias_2:object:pPlane1|test:bias_2:object:pPlaneShape1" "miTransparencyCast" 
		" 1"
		2 "|test:bias_2:object:pPlane1|test:bias_2:object:pPlaneShape1" "miTransparencyReceive" 
		" 1"
		2 "|test:bias_2:object:pPlane1|test:bias_2:object:pPlaneShape1" "miReflectionReceive" 
		" 1"
		2 "|test:bias_2:object:pPlane1|test:bias_2:object:pPlaneShape1" "miRefractionReceive" 
		" 1"
		2 "|test:bias_2:object:pPlane1|test:bias_2:object:pPlaneShape1" "miUpdateProxyBoundingBoxMode" 
		" 0"
		2 "|test:bias_2:object:pPlane1|test:bias_2:object:pPlaneShape1" "miProxyBoundingBoxMin" 
		" -type \"double3\" 0 0 0"
		2 "|test:bias_2:object:pPlane1|test:bias_2:object:pPlaneShape1" "miProxyBoundingBoxMax" 
		" -type \"double3\" 0 0 0"
		2 "|test:bias_2:object:pPlane1|test:bias_2:object:pPlaneShape1" "miShadingSamplesOverride" 
		" 0"
		2 "|test:bias_2:object:pPlane1|test:bias_2:object:pPlaneShape1" "miShadingSamples" 
		" 0"
		2 "|test:bias_2:object:pPlane1|test:bias_2:object:pPlaneShape1" "miMaxDisplaceOverride" 
		" 0"
		2 "|test:bias_2:object:pPlane1|test:bias_2:object:pPlaneShape1" "miMaxDisplace" 
		" 0"
		2 "|test:bias_2:object:directionalLight1" "miDeriveFromMaya" " 1"
		2 "|test:bias_2:object:directionalLight1" "miHide" " 0"
		2 "|test:bias_2:object:directionalLight1" "miVisible" " 2"
		2 "|test:bias_2:object:directionalLight1" "miTrace" " 2"
		2 "|test:bias_2:object:directionalLight1" "miShadow" " 2"
		2 "|test:bias_2:object:directionalLight1" "miCaustic" " 5"
		2 "|test:bias_2:object:directionalLight1" "miGlobillum" " 5"
		2 "|test:bias_2:object:directionalLight1" "miExportGeoShader" " 0"
		2 "|test:bias_2:object:directionalLight1" "miProxyRenderable" " 1"
		2 "|test:bias_2:object:directionalLight1|test:bias_2:object:directionalLightShape1" 
		"miExportMrLight" " 0"
		2 "|test:bias_2:object:directionalLight1|test:bias_2:object:directionalLightShape1" 
		"emitPhotons" " 0"
		2 "|test:bias_2:object:directionalLight1|test:bias_2:object:directionalLightShape1" 
		...
		2 "|test:bias_2:object:directionalLight1|test:bias_2:object:directionalLightShape1" 
		"smapCameraAspect" " 1"
		2 "test:bias_2:object:defaultRenderLayer" "globalIllum" " 0"
		2 "test:bias_2:object:lambert2" "miRefractionBlur" " 0"
		2 "test:bias_2:object:lambert2" "miRefractionRays" " 1"
		2 "test:bias_2:object:lambert2" "miIrradiance" " -type \"float3\" 0 0 0"
		2 "test:bias_2:object:lambert2" "miIrradianceColor" " -type \"float3\" 1 1 1"
		
		2 "test:bias_2:object:lambert2" "miDeriveFromMaya" " 1"
		2 "test:bias_2:object:lambert2" "miRefractiveIndex" " 1"
		2 "test:bias_2:object:lambert2" "miRefractions" " 1"
		2 "test:bias_2:object:lambert2" "miAbsorbs" " 1"
		2 "test:bias_2:object:lambert2" "miDiffuse" " 0.8"
		2 "test:bias_2:object:lambert2" "miColor" " -type \"float3\" 0.5 0.5 0.5"
		
		2 "test:bias_2:object:lambert2" "miTransparency" " -type \"float3\" 0 0 0"
		
		2 "test:bias_2:object:lambert2" "miTranslucence" " 0"
		2 "test:bias_2:object:lambert2" "miTranslucenceFocus" " 0.5"
		2 "test:bias_2:object:lambert2" "miNormalCamera" " -type \"float3\" 0 0 0"
		
		2 "test:bias_2:object:lambert2" "miFrameBufferWriteOperation" " 1"
		2 "test:bias_2:object:lambert2" "miFrameBufferWriteFlags" " 0"
		2 "test:bias_2:object:lambert2" "miFrameBufferWriteFactor" " 1"
		2 "test:bias_2:object:lambert2" "miRefractionBlurLimit" " 1"
		2 "test:bias_2:object:lambert2" "miScatterRadius" " 0"
		2 "test:bias_2:object:lambert2" "miScatterColor" " -type \"float3\" 0.5 0.5 0.5"
		
		2 "test:bias_2:object:lambert2" "miScatterAccuracy" " 97"
		2 "test:bias_2:object:lambert2" "miScatterFalloff" " 0"
		2 "test:bias_2:object:lambert2" "miScatterLimit" " 1"
		2 "test:bias_2:object:lambert2" "miScatterCache" " 0"
		2 "test:bias_2:object:lambert2SG" "miExportMrMaterial" " 0"
		2 "test:bias_2:object:lambert2SG" "miOpaque" " 0"
		2 "test:bias_2:object:lambert2SG" "miCutAwayOpacity" " 0"
		2 "test:bias_2:object:lambert2SG" "miExportShadingEngine" " 1"
		2 "test:bias_2:object:lambert2SG" "miExportVolumeSampler" " 0"
		2 "test:bias_2:object:lambert2SG" "miContourEnable" " 0"
		2 "test:bias_2:object:lambert2SG" "miContourColor" " -type \"float3\" 1 1 1"
		
		2 "test:bias_2:object:lambert2SG" "miContourAlpha" " 1"
		2 "test:bias_2:object:lambert2SG" "miContourWidth" " 1.25"
		2 "test:bias_2:object:lambert2SG" "miContourRelativeWidth" " 0"
		"test:contrast_2:objectRN" 104
		2 "|test:contrast_2:object:pPlane1" "miDeriveFromMaya" " 1"
		2 "|test:contrast_2:object:pPlane1" "miHide" " 0"
		2 "|test:contrast_2:object:pPlane1" "miVisible" " 2"
		2 "|test:contrast_2:object:pPlane1" "miTrace" " 2"
		2 "|test:contrast_2:object:pPlane1" "miShadow" " 2"
		2 "|test:contrast_2:object:pPlane1" "miCaustic" " 5"
		2 "|test:contrast_2:object:pPlane1" "miGlobillum" " 5"
		2 "|test:contrast_2:object:pPlane1" "miExportGeoShader" " 0"
		2 "|test:contrast_2:object:pPlane1" "miProxyRenderable" " 1"
		2 "|test:contrast_2:object:pPlane1|test:contrast_2:object:pPlaneShape1" "miOverrideCaustics" 
		" 0"
		2 "|test:contrast_2:object:pPlane1|test:contrast_2:object:pPlaneShape1" "miCausticAccuracy" 
		" 64"
		2 "|test:contrast_2:object:pPlane1|test:contrast_2:object:pPlaneShape1" "miCausticRadius" 
		" 0"
		2 "|test:contrast_2:object:pPlane1|test:contrast_2:object:pPlaneShape1" "miOverrideGlobalIllumination" 
		" 0"
		2 "|test:contrast_2:object:pPlane1|test:contrast_2:object:pPlaneShape1" "miGlobillumAccuracy" 
		" 64"
		2 "|test:contrast_2:object:pPlane1|test:contrast_2:object:pPlaneShape1" "miGlobillumRadius" 
		" 0"
		2 "|test:contrast_2:object:pPlane1|test:contrast_2:object:pPlaneShape1" "miOverrideFinalGather" 
		" 0"
		2 "|test:contrast_2:object:pPlane1|test:contrast_2:object:pPlaneShape1" "miFinalGatherRays" 
		" 1000"
		2 "|test:contrast_2:object:pPlane1|test:contrast_2:object:pPlaneShape1" "miFinalGatherMinRadius" 
		" 0"
		2 "|test:contrast_2:object:pPlane1|test:contrast_2:object:pPlaneShape1" "miFinalGatherMaxRadius" 
		" 0"
		2 "|test:contrast_2:object:pPlane1|test:contrast_2:object:pPlaneShape1" "miFinalGatherFilter" 
		" 1"
		2 "|test:contrast_2:object:pPlane1|test:contrast_2:object:pPlaneShape1" "miFinalGatherView" 
		" 0"
		2 "|test:contrast_2:object:pPlane1|test:contrast_2:object:pPlaneShape1" "miOverrideSamples" 
		" 0"
		2 "|test:contrast_2:object:pPlane1|test:contrast_2:object:pPlaneShape1" "miMinSamples" 
		" 0"
		2 "|test:contrast_2:object:pPlane1|test:contrast_2:object:pPlaneShape1" "miMaxSamples" 
		" 2"
		2 "|test:contrast_2:object:pPlane1|test:contrast_2:object:pPlaneShape1" "miFinalGatherCast" 
		" 1"
		2 "|test:contrast_2:object:pPlane1|test:contrast_2:object:pPlaneShape1" "miFinalGatherReceive" 
		" 1"
		2 "|test:contrast_2:object:pPlane1|test:contrast_2:object:pPlaneShape1" "miTransparencyCast" 
		" 1"
		2 "|test:contrast_2:object:pPlane1|test:contrast_2:object:pPlaneShape1" "miTransparencyReceive" 
		" 1"
		2 "|test:contrast_2:object:pPlane1|test:contrast_2:object:pPlaneShape1" "miReflectionReceive" 
		" 1"
		2 "|test:contrast_2:object:pPlane1|test:contrast_2:object:pPlaneShape1" "miRefractionReceive" 
		" 1"
		2 "|test:contrast_2:object:pPlane1|test:contrast_2:object:pPlaneShape1" "miUpdateProxyBoundingBoxMode" 
		" 0"
		2 "|test:contrast_2:object:pPlane1|test:contrast_2:object:pPlaneShape1" "miProxyBoundingBoxMin" 
		" -type \"double3\" 0 0 0"
		2 "|test:contrast_2:object:pPlane1|test:contrast_2:object:pPlaneShape1" "miProxyBoundingBoxMax" 
		" -type \"double3\" 0 0 0"
		2 "|test:contrast_2:object:pPlane1|test:contrast_2:object:pPlaneShape1" "miShadingSamplesOverride" 
		" 0"
		2 "|test:contrast_2:object:pPlane1|test:contrast_2:object:pPlaneShape1" "miShadingSamples" 
		" 0"
		2 "|test:contrast_2:object:pPlane1|test:contrast_2:object:pPlaneShape1" "miMaxDisplaceOverride" 
		" 0"
		2 "|test:contrast_2:object:pPlane1|test:contrast_2:object:pPlaneShape1" "miMaxDisplace" 
		" 0"
		2 "|test:contrast_2:object:directionalLight1" "miDeriveFromMaya" " 1"
		2 "|test:contrast_2:object:directionalLight1" "miHide" " 0"
		2 "|test:contrast_2:object:directionalLight1" "miVisible" " 2"
		2 "|test:contrast_2:object:directionalLight1" "miTrace" " 2"
		2 "|test:contrast_2:object:directionalLight1" "miShadow" " 2"
		2 "|test:contrast_2:object:directionalLight1" "miCaustic" " 5"
		2 "|test:contrast_2:object:directionalLight1" "miGlobillum" " 5"
		2 "|test:contrast_2:object:directionalLight1" "miExportGeoShader" " 0"
		2 "|test:contrast_2:object:directionalLight1" "miProxyRenderable" " 1"
		2 "|test:contrast_2:object:directionalLight1|test:contrast_2:object:directionalLightShape1" 
		"miExportMrLight" " 0"
		2 "|test:contrast_2:object:directionalLight1|test:contrast_2:object:directionalLightShape1" 
		"emitPhotons" " 0"
		2 "|test:contrast_2:object:directionalLight1|test:contrast_2:object:directionalLightShape1" 
		...
		2 "|test:contrast_2:object:directionalLight1|test:contrast_2:object:directionalLightShape1" 
		"smapCameraAspect" " 1"
		2 "test:contrast_2:object:defaultRenderLayer" "globalIllum" " 0"
		2 "test:contrast_2:object:lambert2" "miRefractionBlur" " 0"
		2 "test:contrast_2:object:lambert2" "miRefractionRays" " 1"
		2 "test:contrast_2:object:lambert2" "miIrradiance" " -type \"float3\" 0 0 0"
		
		2 "test:contrast_2:object:lambert2" "miIrradianceColor" " -type \"float3\" 1 1 1"
		
		2 "test:contrast_2:object:lambert2" "miDeriveFromMaya" " 1"
		2 "test:contrast_2:object:lambert2" "miRefractiveIndex" " 1"
		2 "test:contrast_2:object:lambert2" "miRefractions" " 1"
		2 "test:contrast_2:object:lambert2" "miAbsorbs" " 1"
		2 "test:contrast_2:object:lambert2" "miDiffuse" " 0.8"
		2 "test:contrast_2:object:lambert2" "miColor" " -type \"float3\" 0.5 0.5 0.5"
		
		2 "test:contrast_2:object:lambert2" "miTransparency" " -type \"float3\" 0 0 0"
		
		2 "test:contrast_2:object:lambert2" "miTranslucence" " 0"
		2 "test:contrast_2:object:lambert2" "miTranslucenceFocus" " 0.5"
		2 "test:contrast_2:object:lambert2" "miNormalCamera" " -type \"float3\" 0 0 0"
		
		2 "test:contrast_2:object:lambert2" "miFrameBufferWriteOperation" " 1"
		2 "test:contrast_2:object:lambert2" "miFrameBufferWriteFlags" " 0"
		2 "test:contrast_2:object:lambert2" "miFrameBufferWriteFactor" " 1"
		2 "test:contrast_2:object:lambert2" "miRefractionBlurLimit" " 1"
		2 "test:contrast_2:object:lambert2" "miScatterRadius" " 0"
		2 "test:contrast_2:object:lambert2" "miScatterColor" " -type \"float3\" 0.5 0.5 0.5"
		
		2 "test:contrast_2:object:lambert2" "miScatterAccuracy" " 97"
		2 "test:contrast_2:object:lambert2" "miScatterFalloff" " 0"
		2 "test:contrast_2:object:lambert2" "miScatterLimit" " 1"
		2 "test:contrast_2:object:lambert2" "miScatterCache" " 0"
		2 "test:contrast_2:object:lambert2SG" "miExportMrMaterial" " 0"
		2 "test:contrast_2:object:lambert2SG" "miOpaque" " 0"
		2 "test:contrast_2:object:lambert2SG" "miCutAwayOpacity" " 0"
		2 "test:contrast_2:object:lambert2SG" "miExportShadingEngine" " 1"
		2 "test:contrast_2:object:lambert2SG" "miExportVolumeSampler" " 0"
		2 "test:contrast_2:object:lambert2SG" "miContourEnable" " 0"
		2 "test:contrast_2:object:lambert2SG" "miContourColor" " -type \"float3\" 1 1 1"
		
		2 "test:contrast_2:object:lambert2SG" "miContourAlpha" " 1"
		2 "test:contrast_2:object:lambert2SG" "miContourWidth" " 1.25"
		2 "test:contrast_2:object:lambert2SG" "miContourRelativeWidth" " 0"
		"test:contrast:objectRN" 104
		2 "|test:contrast:object:pPlane1" "miDeriveFromMaya" " 1"
		2 "|test:contrast:object:pPlane1" "miHide" " 0"
		2 "|test:contrast:object:pPlane1" "miVisible" " 2"
		2 "|test:contrast:object:pPlane1" "miTrace" " 2"
		2 "|test:contrast:object:pPlane1" "miShadow" " 2"
		2 "|test:contrast:object:pPlane1" "miCaustic" " 5"
		2 "|test:contrast:object:pPlane1" "miGlobillum" " 5"
		2 "|test:contrast:object:pPlane1" "miExportGeoShader" " 0"
		2 "|test:contrast:object:pPlane1" "miProxyRenderable" " 1"
		2 "|test:contrast:object:pPlane1|test:contrast:object:pPlaneShape1" "miOverrideCaustics" 
		" 0"
		2 "|test:contrast:object:pPlane1|test:contrast:object:pPlaneShape1" "miCausticAccuracy" 
		" 64"
		2 "|test:contrast:object:pPlane1|test:contrast:object:pPlaneShape1" "miCausticRadius" 
		" 0"
		2 "|test:contrast:object:pPlane1|test:contrast:object:pPlaneShape1" "miOverrideGlobalIllumination" 
		" 0"
		2 "|test:contrast:object:pPlane1|test:contrast:object:pPlaneShape1" "miGlobillumAccuracy" 
		" 64"
		2 "|test:contrast:object:pPlane1|test:contrast:object:pPlaneShape1" "miGlobillumRadius" 
		" 0"
		2 "|test:contrast:object:pPlane1|test:contrast:object:pPlaneShape1" "miOverrideFinalGather" 
		" 0"
		2 "|test:contrast:object:pPlane1|test:contrast:object:pPlaneShape1" "miFinalGatherRays" 
		" 1000"
		2 "|test:contrast:object:pPlane1|test:contrast:object:pPlaneShape1" "miFinalGatherMinRadius" 
		" 0"
		2 "|test:contrast:object:pPlane1|test:contrast:object:pPlaneShape1" "miFinalGatherMaxRadius" 
		" 0"
		2 "|test:contrast:object:pPlane1|test:contrast:object:pPlaneShape1" "miFinalGatherFilter" 
		" 1"
		2 "|test:contrast:object:pPlane1|test:contrast:object:pPlaneShape1" "miFinalGatherView" 
		" 0"
		2 "|test:contrast:object:pPlane1|test:contrast:object:pPlaneShape1" "miOverrideSamples" 
		" 0"
		2 "|test:contrast:object:pPlane1|test:contrast:object:pPlaneShape1" "miMinSamples" 
		" 0"
		2 "|test:contrast:object:pPlane1|test:contrast:object:pPlaneShape1" "miMaxSamples" 
		" 2"
		2 "|test:contrast:object:pPlane1|test:contrast:object:pPlaneShape1" "miFinalGatherCast" 
		" 1"
		2 "|test:contrast:object:pPlane1|test:contrast:object:pPlaneShape1" "miFinalGatherReceive" 
		" 1"
		2 "|test:contrast:object:pPlane1|test:contrast:object:pPlaneShape1" "miTransparencyCast" 
		" 1"
		2 "|test:contrast:object:pPlane1|test:contrast:object:pPlaneShape1" "miTransparencyReceive" 
		" 1"
		2 "|test:contrast:object:pPlane1|test:contrast:object:pPlaneShape1" "miReflectionReceive" 
		" 1"
		2 "|test:contrast:object:pPlane1|test:contrast:object:pPlaneShape1" "miRefractionReceive" 
		" 1"
		2 "|test:contrast:object:pPlane1|test:contrast:object:pPlaneShape1" "miUpdateProxyBoundingBoxMode" 
		" 0"
		2 "|test:contrast:object:pPlane1|test:contrast:object:pPlaneShape1" "miProxyBoundingBoxMin" 
		" -type \"double3\" 0 0 0"
		2 "|test:contrast:object:pPlane1|test:contrast:object:pPlaneShape1" "miProxyBoundingBoxMax" 
		" -type \"double3\" 0 0 0"
		2 "|test:contrast:object:pPlane1|test:contrast:object:pPlaneShape1" "miShadingSamplesOverride" 
		" 0"
		2 "|test:contrast:object:pPlane1|test:contrast:object:pPlaneShape1" "miShadingSamples" 
		" 0"
		2 "|test:contrast:object:pPlane1|test:contrast:object:pPlaneShape1" "miMaxDisplaceOverride" 
		" 0"
		2 "|test:contrast:object:pPlane1|test:contrast:object:pPlaneShape1" "miMaxDisplace" 
		" 0"
		...
		"test:bias_2RN" 1
		2 "test:bias_2:defaultRenderLayer" "globalIllum" " 0";
