...
//Last modified: Tue, Sep 30, 2014 03:20:55 PM
//Codeset: 936
file -rdi 1 -ns "test" -rfn "testRN" "K:/osl/testCase//test_5064/data/test.ma";
file -rdi 2 -ns "alphaGain" -rfn "test:alphaGainRN" "K:/osl/testCase//test_5062/data/alphaGain.ma";
file -rdi 3 -ns "objects" -rfn "test:alphaGain:objectsRN" "objects.ma";
file -rdi 2 -ns "alphaIsLuminance" -rfn "test:alphaIsLuminanceRN" "K:/osl/testCase//test_5062/data/alphaIsLuminance.ma";
file -rdi 3 -ns "objects" -rfn "test:alphaIsLuminance:objectsRN" "objects.ma";
file -rdi 2 -ns "alphaOffset" -rfn "test:alphaOffsetRN" "K:/osl/testCase//test_5062/data/alphaOffset.ma";
file -rdi 3 -ns "objects" -rfn "test:alphaOffset:objectsRN" "objects.ma";
file -rdi 2 -ns "amplitude" -rfn "test:amplitudeRN" "K:/osl/testCase//test_5062/data/amplitude.ma";
file -rdi 3 -ns "objects" -rfn "test:amplitude:objectsRN" "objects.ma";
file -rdi 2 -ns "colorGain" -rfn "test:colorGainRN" "K:/osl/testCase//test_5062/data/colorGain.ma";
file -rdi 3 -ns "objects" -rfn "test:colorGain:objectsRN" "objects.ma";
file -rdi 2 -ns "colorOffset" -rfn "test:colorOffsetRN" "K:/osl/testCase//test_5062/data/colorOffset.ma";
file -rdi 3 -ns "objects" -rfn "test:colorOffset:objectsRN" "objects.ma";
file -rdi 2 -ns "contrast" -rfn "test:contrastRN" "K:/osl/testCase//test_5062/data/contrast.ma";
file -rdi 3 -ns "objects" -rfn "test:contrast:objectsRN" "objects.ma";
file -rdi 2 -ns "defaultColor" -rfn "test:defaultColorRN" "K:/osl/testCase//test_5062/data/defaultColor.ma";
file -rdi 3 -ns "objects" -rfn "test:defaultColor:objectsRN" "objects.ma";
file -rdi 2 -ns "depth" -rfn "test:depthRN" "K:/osl/testCase//test_5062/data/depth.ma";
file -rdi 3 -ns "objects" -rfn "test:depth:objectsRN" "objects.ma";
file -rdi 2 -ns "diffusion" -rfn "test:diffusionRN" "K:/osl/testCase//test_5062/data/diffusion.ma";
file -rdi 3 -ns "objects" -rfn "test:diffusion:objectsRN" "objects.ma";
file -rdi 2 -ns "fillerColor" -rfn "test:fillerColorRN" "K:/osl/testCase//test_5062/data/fillerColor.ma";
file -rdi 3 -ns "objects" -rfn "test:fillerColor:objectsRN" "objects.ma";
file -rdi 2 -ns "invert" -rfn "test:invertRN" "K:/osl/testCase//test_5062/data/invert.ma";
file -rdi 3 -ns "objects" -rfn "test:invert:objectsRN" "objects.ma";
file -rdi 2 -ns "ratio" -rfn "test:ratioRN" "K:/osl/testCase//test_5062/data/ratio.ma";
file -rdi 3 -ns "objects" -rfn "test:ratio:objectsRN" "objects.ma";
file -rdi 2 -ns "ripples" -rfn "test:ripplesRN" "K:/osl/testCase//test_5062/data/ripples.ma";
file -rdi 3 -ns "objects" -rfn "test:ripples:objectsRN" "objects.ma";
file -rdi 2 -ns "veinColor" -rfn "test:veinColorRN" "K:/osl/testCase//test_5062/data/veinColor.ma";
file -rdi 3 -ns "objects" -rfn "test:veinColor:objectsRN" "objects.ma";
file -rdi 2 -ns "veinWidth" -rfn "test:veinWidthRN" "K:/osl/testCase//test_5062/data/veinWidth.ma";
file -rdi 3 -ns "objects" -rfn "test:veinWidth:objectsRN" "objects.ma";
file -rdi 2 -ns "filter" -rfn "test:filterRN" "D:/Projects/2014/osl/testCase//test_5062/data/filter.ma";
file -rdi 3 -ns "objects" -rfn "test:filter:objectsRN" "objects.ma";
file -rdi 2 -ns "filterOffset" -rfn "test:filterOffsetRN" "D:/Projects/2014/osl/testCase//test_5062/data/filterOffset.ma";
file -rdi 3 -ns "objects" -rfn "test:filterOffset:objectsRN" "objects.ma";
file -rdi 2 -ns "wrap" -rfn "test:wrapRN" "D:/Projects/2014/osl/testCase//test_5062/data/wrap.ma";
file -rdi 3 -ns "objects" -rfn "test:wrap:objectsRN" "objects.ma";
file -rdi 2 -ns "local" -rfn "test:localRN" "D:/Projects/2014/osl/testCase//test_5062/data/local.ma";
file -rdi 3 -ns "objects" -rfn "test:local:objectsRN" "objects.ma";
file -rdi 2 -ns "blend" -rfn "test:blendRN" "D:/Projects/2014/osl/testCase//test_5062/data/blend.ma";
file -rdi 3 -ns "objects" -rfn "test:blend:objectsRN" "objects.ma";
file -r -ns "test" -dr 1 -rfn "testRN" "K:/osl/testCase//test_5064/data/test.ma";
requires maya "2013";
...
createNode reference -n "testRN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		"test:filterOffset:objectsRN" 0
		"test:alphaGainRN" 0
		"test:contrast:objectsRN" 0
		"test:filterOffsetRN" 0
		"test:filter:objectsRN" 0
		"test:defaultColor:objectsRN" 0
		"test:ripples:objectsRN" 0
		"test:blend:objectsRN" 0
		"test:veinWidth:objectsRN" 0
		"test:alphaGain:objectsRN" 0
		"test:contrastRN" 0
		"test:localRN" 0
		"test:wrap:objectsRN" 0
		"test:diffusion:objectsRN" 0
		"test:diffusionRN" 0
		"test:alphaOffset:objectsRN" 0
		"test:wrapRN" 0
		"test:ratio:objectsRN" 0
		"test:invert:objectsRN" 0
		"test:colorOffsetRN" 0
		"test:colorGainRN" 0
		"test:ratioRN" 0
		"test:alphaOffsetRN" 0
		"test:depth:objectsRN" 0
		"test:alphaIsLuminanceRN" 0
		"test:filterRN" 0
		"test:alphaIsLuminance:objectsRN" 0
		"test:depthRN" 0
		"test:fillerColor:objectsRN" 0
		"test:ripplesRN" 0
		"test:veinColor:objectsRN" 0
		"test:amplitudeRN" 0
		"test:local:objectsRN" 0
		"test:invertRN" 0
		"test:blendRN" 0
		"test:veinWidthRN" 0
