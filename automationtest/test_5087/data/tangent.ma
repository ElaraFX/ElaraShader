...
//Name: tangent.ma
//Last modified: Fri, Oct 24, 2014 05:50:16 PM
//Codeset: 936
file -rdi 1 -ns "object" -rfn "objectRN" "K:/osl/testCase//test_5087/data/object.ma";
file -r -ns "object" -dr 1 -rfn "objectRN" "K:/osl/testCase//test_5087/data/object.ma";
requires maya "2013";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 5.0005288809830422 3.7503966607372559 5.0005288809830191 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 8.0047519194513477;
...
createNode reference -n "objectRN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		"objectRN" 0
		"objectRN" 7
		2 "|object:lights" "visibility" " 0"
		2 "object:displacementShader1" "scale" " 0.5"
		2 "object:displacementShader1" "vectorEncoding" " 0"
		2 "object:displacementShader1" "vectorSpace" " 1"
		2 "object:displacementShader1" "_3delight_displacementBound" " 1"
		5 0 "objectRN" "object:file1.outColor" "object:displacementShader1.vectorDisplacement" 
		"objectRN.placeHolderList[1]" "objectRN.placeHolderList[2]" ""
		5 4 "objectRN" "object:displacementShader1.tangent" "objectRN.placeHolderList[3]" 
		"";
...
createNode file -n "file1";
	setAttr ".ftn" -type "string" "D:/Projects/2014/osl/testCase//test_5087/data/noiseTangent.exr";
...
createNode hyperLayout -n "hyperLayout1";
	setAttr ".ihi" 0;
	setAttr -s 6 ".hyp";
	setAttr ".hyp[0].nvs" 3088;
	setAttr ".hyp[1].nvs" 2736;
	setAttr ".hyp[2].nvs" 2528;
	setAttr ".hyp[3].nvs" 3792;
	setAttr ".hyp[4].nvs" 2528;
	setAttr ".hyp[5].nvs" 4272;
	setAttr ".anf" yes;
select -ne :time1;
	setAttr ".o" 1;
	setAttr ".unw" 1;
...
connectAttr "objectRN.phl[1]" "objectRN.phl[2]";
connectAttr "file1.oc" "objectRN.phl[3]";
...
connectAttr ":defaultElaraRenderOptions.msg" "hyperLayout1.hyp[0].dn";
connectAttr "delightRenderGlobals1.msg" "hyperLayout1.hyp[1].dn";
connectAttr "renderPass.msg" "hyperLayout1.hyp[2].dn";
connectAttr "delightRenderPass1_pixelRatioExpr.msg" "hyperLayout1.hyp[3].dn";
