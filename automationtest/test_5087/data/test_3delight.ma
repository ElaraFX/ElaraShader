...
//Last modified: Mon, Sep 29, 2014 12:07:04 PM
//Codeset: 936
...
file -rdi 2 -ns "scale" -rfn "test:scaleRN" "K:/osl/testCase//test_5087/data/scale.ma";
file -rdi 3 -ns "object" -rfn "test:scale:objectRN" "K:/osl/testCase//test_5087/data/object.ma";
file -rdi 2 -ns "vectorDisplacement" -rfn "test:vectorDisplacementRN" "K:/osl/testCase//test_5087/data/vectorDisplacement.ma";
file -rdi 3 -ns "object" -rfn "test:vectorDisplacement:objectRN" "K:/osl/testCase//test_5087/data/object.ma";
file -rdi 2 -ns "tangent" -rfn "test:tangentRN" "K:/osl/testCase//test_5087/data/tangent.ma";
file -rdi 3 -ns "object" -rfn "test:tangent:objectRN" "K:/osl/testCase//test_5087/data/object.ma";
file -rdi 2 -ns "vectorEncoding" -rfn "test:vectorEncodingRN" "K:/osl/testCase//test_5087/data/vectorEncoding.ma";
file -rdi 3 -ns "object" -rfn "test:vectorEncoding:objectRN" "K:/osl/testCase//test_5087/data/object.ma";
file -rdi 2 -ns "vectorSpace" -rfn "test:vectorSpaceRN" "K:/osl/testCase//test_5087/data/vectorSpace.ma";
file -rdi 3 -ns "object" -rfn "test:vectorSpace:objectRN" "K:/osl/testCase//test_5087/data/object.ma";
file -rdi 2 -ns "vectorSpace2" -rfn "test:vectorSpace2RN" "K:/osl/testCase//test_5087/data/vectorSpace2.ma";
file -rdi 3 -ns "object" -rfn "test:vectorSpace2:objectRN" "K:/osl/testCase//test_5087/data/object.ma";
file -r -ns "test" -dr 1 -rfn "testRN" "K:/osl/testCase//test_5087/data/test.ma";
requires maya "2013";
...
createNode reference -n "testRN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		"test:scale:objectRN" 3
		2 "|test:scale:object:objects" "isCollapsed" " 1"
		2 "test:scale:object:displacementShader1" "vectorSpace" " 2"
		2 "test:scale:object:displacementShader1" "_3delight_displacementBound" " 1"
		
		"test:vectorDisplacement:objectRN" 7
		2 "|test:vectorDisplacement:object:objects" "isCollapsed" " 1"
		2 "test:vectorDisplacement:object:displacementShader1" "_3delight_displacementBound" 
		" 1"
		5 3 "testRN" "test:vectorDisplacement:object:lambert2.message" "testRN.placeHolderList[1]" 
		""
		5 3 "testRN" "test:vectorDisplacement:object:lambert2SG.message" "testRN.placeHolderList[2]" 
		""
		5 3 "testRN" "test:vectorDisplacement:object:file1.message" "testRN.placeHolderList[3]" 
		""
		5 3 "testRN" "test:vectorDisplacement:object:place2dTexture2.message" 
		"testRN.placeHolderList[4]" ""
		5 3 "testRN" "test:vectorDisplacement:object:displacementShader1.message" 
		"testRN.placeHolderList[5]" ""
		"test:vectorEncoding:objectRN" 6
		2 "|test:vectorEncoding:object:objects" "isCollapsed" " 1"
		2 "|test:vectorEncoding:object:objects|test:vectorEncoding:object:pSphere1|test:vectorEncoding:object:pSphereShape1" 
		"boundingBoxScale" " -type \"float3\" 2.041217 2.041217 2.041217"
		2 "|test:vectorEncoding:object:objects|test:vectorEncoding:object:pPlane1|test:vectorEncoding:object:pPlaneShape1" 
		"boundingBoxScale" " -type \"float3\" 10.936072 10.936072 10.936072"
		2 "test:vectorEncoding:object:displacementShader1" "_3delight_displacementBound" 
		" 1"
		5 3 "testRN" "|test:vectorEncoding:object:objects|test:vectorEncoding:object:pSphere1|test:vectorEncoding:object:pSphereShape1.instObjGroups" 
		"testRN.placeHolderList[6]" ""
		5 3 "testRN" "|test:vectorEncoding:object:objects|test:vectorEncoding:object:pPlane1|test:vectorEncoding:object:pPlaneShape1.instObjGroups" 
		"testRN.placeHolderList[7]" ""
		"testRN" 8
...
createNode eiOptions -s -n "defaultElaraRenderOptions";
	...
	setAttr ".vis" 1;
	setAttr ".dp" yes;
	setAttr ".use_clamp" yes;
	setAttr ".clamp_value" 1;
createNode script -n "uiConfigurationScriptNode";
	setAttr ".b" -type "string" (
		...
		+ "\t\tif (!$useSceneConfig) {\n\t\t\tpanel -e -l $label $panelName;\n\t\t}\n\t}\n\n\n\tif ($useSceneConfig) {\n        string $configName = `getPanel -cwl (localizedPanelLabel(\"Current Layout\"))`;\n        if (\"\" != $configName) {\n\t\t\tpanelConfiguration -edit -label (localizedPanelLabel(\"Current Layout\")) \n\t\t\t\t-defaultImage \"vacantCell.xP:/\"\n\t\t\t\t-image \"\"\n\t\t\t\t-sc false\n\t\t\t\t-configString \"global string $gMainPane; paneLayout -e -cn \\\"left3\\\" -ps 1 51 100 -ps 2 49 100 -ps 3 51 0 $gMainPane;\"\n\t\t\t\t-removeAllPanels\n\t\t\t\t-ap false\n\t\t\t\t\t(localizedPanelLabel(\"Hypershade\")) \n\t\t\t\t\t\"scriptedPanel\"\n\t\t\t\t\t\"$panelName = `scriptedPanel -unParent  -type \\\"hyperShadePanel\\\" -l (localizedPanelLabel(\\\"Hypershade\\\")) -mbv $menusOkayInPanels `\"\n\t\t\t\t\t\"scriptedPanel -edit -l (localizedPanelLabel(\\\"Hypershade\\\")) -mbv $menusOkayInPanels  $panelName\"\n\t\t\t\t-ap false\n\t\t\t\t\t(localizedPanelLabel(\"Persp View\")) \n\t\t\t\t\t\"modelPanel\"\n"
		+ "\t\t\t\t\t\"$panelName = `modelPanel -unParent -l (localizedPanelLabel(\\\"Persp View\\\")) -mbv $menusOkayInPanels `;\\n$editorName = $panelName;\\nmodelEditor -e \\n    -camera \\\"test:persp1\\\" \\n    -useInteractiveMode 0\\n    -displayLights \\\"default\\\" \\n    -displayAppearance \\\"wireframe\\\" \\n    -activeOnly 0\\n    -ignorePanZoom 0\\n    -wireframeOnShaded 0\\n    -headsUpDisplay 1\\n    -selectionHiliteDisplay 1\\n    -useDefaultMaterial 0\\n    -bufferMode \\\"double\\\" \\n    -twoSidedLighting 1\\n    -backfaceCulling 0\\n    -xray 0\\n    -jointXray 0\\n    -activeComponentsXray 0\\n    -displayTextures 0\\n    -smoothWireframe 0\\n    -lineWidth 1\\n    -textureAnisotropic 0\\n    -textureHilight 1\\n    -textureSampling 2\\n    -textureDisplay \\\"modulate\\\" \\n    -textureMaxSize 1024\\n    -fogging 0\\n    -fogSource \\\"fragment\\\" \\n    -fogMode \\\"linear\\\" \\n    -fogStart 0\\n    -fogEnd 100\\n    -fogDensity 0.1\\n    -fogColor 0.5 0.5 0.5 1 \\n    -maxConstantTransparency 1\\n    -rendererName \\\"base_OpenGL_Renderer\\\" \\n    -objectFilterShowInHUD 1\\n    -isFiltered 0\\n    -colorResolution 256 256 \\n    -bumpResolution 512 512 \\n    -textureCompression 0\\n    -transparencyAlgorithm \\\"frontAndBackCull\\\" \\n    -transpInShadows 0\\n    -cullingOverride \\\"none\\\" \\n    -lowQualityLighting 0\\n    -maximumNumHardwareLights 1\\n    -occlusionCulling 0\\n    -shadingModel 0\\n    -useBaseRenderer 0\\n    -useReducedRenderer 0\\n    -smallObjectCulling 0\\n    -smallObjectThreshold -1 \\n    -interactiveDisableShadows 0\\n    -interactiveBackFaceCull 0\\n    -sortTransparent 1\\n    -nurbsCurves 1\\n    -nurbsSurfaces 1\\n    -polymeshes 1\\n    -subdivSurfaces 1\\n    -planes 1\\n    -lights 1\\n    -cameras 1\\n    -controlVertices 1\\n    -hulls 1\\n    -grid 1\\n    -imagePlane 1\\n    -joints 1\\n    -ikHandles 1\\n    -deformers 1\\n    -dynamics 1\\n    -fluids 1\\n    -hairSystems 1\\n    -follicles 1\\n    -nCloths 1\\n    -nParticles 1\\n    -nRigids 1\\n    -dynamicConstraints 1\\n    -locators 1\\n    -manipulators 1\\n    -dimensions 1\\n    -handles 1\\n    -pivots 1\\n    -textures 1\\n    -strokes 1\\n    -motionTrails 1\\n    -clipGhosts 1\\n    -shadows 0\\n    $editorName;\\nmodelEditor -e -viewSelected 0 $editorName\"\n"
		+ "\t\t\t\t\t\"modelPanel -edit -l (localizedPanelLabel(\\\"Persp View\\\")) -mbv $menusOkayInPanels  $panelName;\\n$editorName = $panelName;\\nmodelEditor -e \\n    -camera \\\"test:persp1\\\" \\n    -useInteractiveMode 0\\n    -displayLights \\\"default\\\" \\n    -displayAppearance \\\"wireframe\\\" \\n    -activeOnly 0\\n    -ignorePanZoom 0\\n    -wireframeOnShaded 0\\n    -headsUpDisplay 1\\n    -selectionHiliteDisplay 1\\n    -useDefaultMaterial 0\\n    -bufferMode \\\"double\\\" \\n    -twoSidedLighting 1\\n    -backfaceCulling 0\\n    -xray 0\\n    -jointXray 0\\n    -activeComponentsXray 0\\n    -displayTextures 0\\n    -smoothWireframe 0\\n    -lineWidth 1\\n    -textureAnisotropic 0\\n    -textureHilight 1\\n    -textureSampling 2\\n    -textureDisplay \\\"modulate\\\" \\n    -textureMaxSize 1024\\n    -fogging 0\\n    -fogSource \\\"fragment\\\" \\n    -fogMode \\\"linear\\\" \\n    -fogStart 0\\n    -fogEnd 100\\n    -fogDensity 0.1\\n    -fogColor 0.5 0.5 0.5 1 \\n    -maxConstantTransparency 1\\n    -rendererName \\\"base_OpenGL_Renderer\\\" \\n    -objectFilterShowInHUD 1\\n    -isFiltered 0\\n    -colorResolution 256 256 \\n    -bumpResolution 512 512 \\n    -textureCompression 0\\n    -transparencyAlgorithm \\\"frontAndBackCull\\\" \\n    -transpInShadows 0\\n    -cullingOverride \\\"none\\\" \\n    -lowQualityLighting 0\\n    -maximumNumHardwareLights 1\\n    -occlusionCulling 0\\n    -shadingModel 0\\n    -useBaseRenderer 0\\n    -useReducedRenderer 0\\n    -smallObjectCulling 0\\n    -smallObjectThreshold -1 \\n    -interactiveDisableShadows 0\\n    -interactiveBackFaceCull 0\\n    -sortTransparent 1\\n    -nurbsCurves 1\\n    -nurbsSurfaces 1\\n    -polymeshes 1\\n    -subdivSurfaces 1\\n    -planes 1\\n    -lights 1\\n    -cameras 1\\n    -controlVertices 1\\n    -hulls 1\\n    -grid 1\\n    -imagePlane 1\\n    -joints 1\\n    -ikHandles 1\\n    -deformers 1\\n    -dynamics 1\\n    -fluids 1\\n    -hairSystems 1\\n    -follicles 1\\n    -nCloths 1\\n    -nParticles 1\\n    -nRigids 1\\n    -dynamicConstraints 1\\n    -locators 1\\n    -manipulators 1\\n    -dimensions 1\\n    -handles 1\\n    -pivots 1\\n    -textures 1\\n    -strokes 1\\n    -motionTrails 1\\n    -clipGhosts 1\\n    -shadows 0\\n    $editorName;\\nmodelEditor -e -viewSelected 0 $editorName\"\n"
...
createNode hyperView -n "hyperView1";
	setAttr ".vl" -type "double2" 408.82954000344643 -42561.216395555173 ;
	setAttr ".vh" -type "double2" 1719.7740076212438 -42254.761844683482 ;
	setAttr ".dag" no;
createNode hyperLayout -n "hyperLayout1";
	setAttr ".ihi" 0;
	setAttr -s 15 ".hyp";
	setAttr ".hyp[0].x" 521.4285888671875;
	setAttr ".hyp[0].y" -42767.14453125;
	setAttr ".hyp[0].nvs" 3824;
	setAttr ".hyp[1].x" 997.14288330078125;
	setAttr ".hyp[1].y" -42604.28515625;
	setAttr ".hyp[1].nvs" 4192;
	setAttr ".hyp[2].x" 2000;
	setAttr ".hyp[2].y" -42604.28515625;
	setAttr ".hyp[2].nvs" 1920;
	setAttr ".hyp[3].x" 952.85711669921875;
	setAttr ".hyp[3].y" -42767.14453125;
	setAttr ".hyp[3].nvs" 5168;
	setAttr ".hyp[4].x" 1504.2857666015625;
	setAttr ".hyp[4].y" -42685.71484375;
	setAttr ".hyp[4].nvs" 4400;
	setAttr ".hyp[5].x" 1.4285714626312256;
	setAttr ".hyp[5].y" -42767.14453125;
	setAttr ".hyp[5].nvs" 4832;
	setAttr ".hyp[6].x" 1988.5714111328125;
	setAttr ".hyp[6].y" -42767.14453125;
	setAttr ".hyp[6].nvs" 2176;
	setAttr ".hyp[7].x" 1071.11181640625;
	setAttr ".hyp[7].y" -42414.80078125;
	setAttr ".hyp[7].nvs" 2736;
	setAttr ".hyp[8].x" 822.54046630859375;
	setAttr ".hyp[8].y" -42486.265625;
	setAttr ".hyp[8].nvs" 2528;
	setAttr ".hyp[9].x" 822.54046630859375;
	setAttr ".hyp[9].y" -42321.94140625;
	setAttr ".hyp[9].nvs" 3792;
	setAttr ".hyp[10].x" 573.968994140625;
	setAttr ".hyp[10].y" -42254.76171875;
	setAttr ".hyp[10].nvs" 2528;
	setAttr ".hyp[11].x" 573.968994140625;
	setAttr ".hyp[11].y" -42159.046875;
	setAttr ".hyp[11].nvs" 4272;
	setAttr ".hyp[12].x" 1312.5404052734375;
	setAttr ".hyp[12].y" -42254.76171875;
	setAttr ".hyp[12].nvs" 2448;
	setAttr ".hyp[13].x" 1542.5404052734375;
	setAttr ".hyp[13].y" -42486.265625;
	setAttr ".hyp[13].nvs" 2320;
	setAttr ".hyp[14].x" 1531.11181640625;
	setAttr ".hyp[14].y" -42393.40625;
	setAttr ".hyp[14].nvs" 2320;
	setAttr ".anf" yes;
...
createNode expression -n "delightRenderPass1_pixelRatioExpr";
	...
	setAttr ".ani" 0;
createNode delightGeoAttribs -n "delightGeoAttribs1";
	addAttr -ci true -sn "altParent" -ln "altParent" -at "message";
	addAttr -ci true -sn "inheritDAGParentAttributes" -ln "inheritDAGParentAttributes" 
		-dv 1 -min 0 -max 1 -at "bool";
	addAttr -ci true -sn "version" -ln "version" -dt "string";
	addAttr -ci true -h true -sn "usedBy3dfm" -ln "usedBy3dfm" -at "message";
	addAttr -ci true -sn "displacementBound" -ln "displacementBound" -min 0 -at "float";
	addAttr -ci true -sn "displacementBoundSpace" -ln "displacementBoundSpace" -dt "string";
	setAttr ".version" -type "string" "7.0.12";
	setAttr ".displacementBound" 5;
	setAttr ".displacementBoundSpace" -type "string" "shader";
createNode delightShapeSet -n "delightShapeSet1";
	...
	setAttr ".version" -type "string" "7.0.12";
createNode delightShapeSet -n "delightShapeSet2";
	addAttr -ci true -sn "version" -ln "version" -dt "string";
	addAttr -ci true -sn "shaderCollections" -ln "shaderCollections" -at "message";
	addAttr -ci true -sn "surface" -ln "surface" -at "message";
	addAttr -ci true -sn "displacement" -ln "displacement" -at "message";
...
connectAttr "testRN.phl[1]" "hyperLayout1.hyp[1].dn";
connectAttr "testRN.phl[2]" "hyperLayout1.hyp[4].dn";
connectAttr "testRN.phl[3]" "hyperLayout1.hyp[0].dn";
connectAttr "testRN.phl[4]" "hyperLayout1.hyp[5].dn";
connectAttr "testRN.phl[5]" "hyperLayout1.hyp[3].dn";
connectAttr "testRN.phl[6]" "delightShapeSet1.dsm" -na;
connectAttr "testRN.phl[7]" "delightShapeSet2.dsm" -na;
connectAttr "testRN.phl[8]" "renderPass.camera";
...
connectAttr ":renderPartition.msg" "hyperLayout1.hyp[6].dn";
connectAttr "delightRenderGlobals1.msg" "hyperLayout1.hyp[7].dn";
connectAttr "renderPass.msg" "hyperLayout1.hyp[8].dn";
connectAttr "delightRenderPass1_pixelRatioExpr.msg" "hyperLayout1.hyp[9].dn";
connectAttr "delightGeoAttribs1.msg" "hyperLayout1.hyp[12].dn";
connectAttr "delightShapeSet1.msg" "hyperLayout1.hyp[13].dn";
connectAttr "delightShapeSet2.msg" "hyperLayout1.hyp[14].dn";
...
connectAttr "delightGeoAttribs1.usedBy3dfm" "delightShapeSet1.geoAttribs";
connectAttr "delightGeoAttribs1.usedBy3dfm" "delightShapeSet2.geoAttribs";
